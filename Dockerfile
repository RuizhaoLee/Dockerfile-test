...
ENV PHP_DEPS="curl-dev enchant-dev libpng-dev gmp-dev libc-dev gc-dev imap-dev icu-dev icu-libs oniguruma-dev postgresql-dev libpq aspell-dev aspell-libs net-snmp-dev libxml2-dev minizip-dev"
